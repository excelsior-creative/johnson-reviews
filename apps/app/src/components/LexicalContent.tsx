...
export function LexicalContent({ content, className }: LexicalContentProps) {
  ...
  return (
    <div
      className={
        className ??
        "prose prose-invert prose-lg max-w-none prose-headings:font-headline prose-headings:text-[#e5e2e1] prose-p:text-[#e5e2e1]/85 prose-p:leading-relaxed prose-strong:text-[#e5e2e1] prose-ul:text-[#e5e2e1]/85 prose-ol:text-[#e5e2e1]/85 prose-li:marker:text-[#f2ca50] prose-blockquote:border-[#f2ca50] prose-blockquote:text-[#d3c5ad] prose-blockquote:italic prose-a:text-[#f2ca50] prose-a:no-underline hover:prose-a:underline"
      }
    >
      {children.map((node, i) => (
