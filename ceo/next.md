...
Ready specs queued from existing roadmap/backlog items after Brandon asked Peter to move the project forward in Slack thread C0AHR2NJ361 / 1777339258.868489 on 2026-04-27.
...
- Production deploy remains blocked by `ceo/INBOX.md` urgent item #11 until Brandon confirms Vercel production is deploying from `main` and the canonical branch/URL are correct.
- Legacy review migration remains blocked by `ceo/INBOX.md` items #12 and #13 until Brandon chooses the migration policy and fact-checks the first Dana Point batch.
